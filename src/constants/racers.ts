export const racers = [
  ...
  {
    season: 1,
    label: 'Victoria "Porkchop" Parker',
    age: 39,
  ...
  {
    season: 2,
    label: "Morgan McMichaels",
    age: 28,
    hometown: "Mira Loma, California",
    outcome: 8
  },
  {
    season: 2,
  ...
  {
    season: 2,
    label: "Mystique Summers Madison",
    age: 25,
    hometown: "Chicago, Illinois",
    outcome: 10
  },
...
/**  {
  ...
  Eureka[n]	25	Johnson City, Tennessee	11th[o]
  ...
  A'keria C. Davenport[p]	30	Dallas, Texas	3rd
  ...
  Ra'Jah O'Hara[q]	33	Dallas, Texas	9th
  ...
  Sherry Pie	27	New York City, New York	Disqualified[r]
  ...
  Jan[s]	26	New York City, New York	8th
  Brita[t]	34	New York City, New York	9th
